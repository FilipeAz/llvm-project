...
enum TypeCodes {
  ...
  TYPE_CODE_REALLY_PACKED_STRUCT_ANON = 23, // REALLY_PACKED_STRUCT_ANON: [eltty x N]
  TYPE_CODE_REALLY_PACKED_STRUCT_NAMED = 24, // REALLY_PACKED_STRUCT_NAMED: [eltty x N]
  TYPE_CODE_REALLY_PACKED_STRUCT_OPAQUE = 25 // REALLY_PACKED_STRUCT_OPAQUE: []
};
