...
enum TypeCodes {
  ...
  TYPE_CODE_EXPLICITLY_PACKED_STRUCT_ANON = 23, // EXPLICITLY_PACKED_STRUCT_ANON: [eltty x N]
  TYPE_CODE_EXPLICITLY_PACKED_STRUCT_NAMED = 24, // EXPLICITLY_PACKED_STRUCT_NAMED: [eltty x N]
  TYPE_CODE_EXPLICITLY_PACKED_STRUCT_OPAQUE = 25 // EXPLICITLY_PACKED_STRUCT_OPAQUE: []
};
...
enum FunctionCodes {
  ...
  FUNC_CODE_INST_FREEZE = 57,    // FREEZE: [opty, opval]
};
