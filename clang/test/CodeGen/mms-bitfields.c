...
// CHECK: @variable = global %struct.Inner \{ i1 true, i1 false, i1 true, i5 0, [3 x i8] undef, i30 21, i2 0 }/, align 1
// CHECK: @hdr = global %union.HEADER { %struct.A \{ i3 0, i9 1, i12 0, i8 0, i17 2, i7 0, i4 3, i4 0, i3 -4, i5 0, [3 x i8] undef }/ }, align 1
